...
for i in initial_coefficients:
    if min_error > (float(abs(initial_coefficients[i][0] - ratio * initial_coefficients[i][1]) + 0 * abs(initial_coefficients[i][0] - ratio * initial_coefficients[i][1])), float(abs(initial_coefficients[i][0] + ratio * initial_coefficients[i][1]))):
        min_error = (float(abs(initial_coefficients[i][0] - ratio * initial_coefficients[i][1]) + 0 * abs(initial_coefficients[i][0] - ratio * initial_coefficients[i][1])), float(abs(initial_coefficients[i][0] + ratio * initial_coefficients[i][1])))
    ...
    errors.append(((float(abs(initial_coefficients[i][0] - ratio * initial_coefficients[i][1]) + 0 * abs(initial_coefficients[i][0] - ratio * initial_coefficients[i][1])), float(abs(initial_coefficients[i][0] + ratio * initial_coefficients[i][1]))), list(map(
...
for i in range(num_generations):
    ...
    fitness = [(abs(err[j][0] + err[j][1]) - 0 * abs(err[j][0] - err[j][1]), abs(err[j][0] + ratio * err[j][1])) for j in range(k)]
